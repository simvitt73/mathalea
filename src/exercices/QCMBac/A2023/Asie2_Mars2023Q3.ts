...
export default class SujetZero2024Ex5Q5 extends ExerciceQcm {
  versionOriginale: () => void = () => {
    this.reponses = [
      ...
      '$\\dfrac{17}{84}$',
      '$\\dfrac{168}{34}$',
      '$\\dfrac{168}{673} \\times \\dfrac{34}{673}$'
    ]
...
Pour répondre aux questions suivantes on pourra utiliser l'arbre pondéré ci-dessous et on donne $p(A \\cap B) = \\dfrac{34}{673}$`
      : ''
    this.enonce += '<br>La probabilité d\'obtenir un multiple de $4$ ayant $6$ comme chiffre des unités est :'
    this.correction = 'La probabilité d’obtenir un multiple de 4 ayant 6 comme chiffre des unités est donnée par $p(A \\cap B) = \\dfrac{34}{673}$'
  }
