...
export const titre = 'QCM Bac Madagascar 2022 : Équation de tangente d\'une fonction en logarithme népérien.'
...
export default class SujetZero2024Ex5Q5 extends ExerciceQcm {
  versionOriginale: () => void = () => {
    ...
    this.enonce += '<br>On admet que $h$ est deux fois dérivable sur l\'intervalle $]0~;~2]$.'
    ...
    this.correction += 'Sur l\'intervalle $]0~;~2]$, $h\'\'\'(x) > 0$, donc $h\'\'(x)$ est croissante.<br>'
    ...
    this.correction += 'La dérivée seconde s\'annule donc une seule fois sur l\'intervalle $]0~;~2]$ en changeant de signe.<br>'
