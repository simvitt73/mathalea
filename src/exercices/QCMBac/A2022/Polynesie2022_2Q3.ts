...
export default class SujetZero2024Ex5Q5 extends ExerciceQcm {
  versionOriginale: () => void = () => {
    ...
    this.enonce += 'Le nombre de solutions de l\'équation $f(x) = 0$ sur $\\R$ est :'

    this.correction = 'On factorise $f(x)$ :<br>'
    this.correction += '$f(x) = x(x^2 - 0,9x - 0,1).$<br>'
    this.correction += 'Ainsi, $f(x) = 0$ équivaut à :<br>'
    this.correction += '$x = 0 \\quad \\text{ou} \\quad x^2 - 0,9x - 0,1 = 0.$<br>'
    this.correction += 'L\'équation du second degré $x^2 - 0,9x - 0,1 = 0$ admet deux solutions : $1$ et $-0,1$.<br>'
