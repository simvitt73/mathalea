...
const qcmData = {
  ...
  consigne: "Pour chaque fonction, déterminez l'expression de sa fonction dérivée.",
  options: {
    vertical: true,
    ordered: false,
    lastChoice: 8
  ...
  questions: [
    ...
    {
      enonce: 'Quelle est la dérivée de $f(x) = 5\\sqrt{x} - 5x^2 + 5x$ sur $\\mathbb{R}_+^*$ ?',
      reponses: [
    ...
    {
      enonce: 'Quelle est la dérivée de $f(x) = 4x^2 - \\frac{3}{x}$ sur $\\mathbb{R}^*$ ?',
      reponses: [
        "$f'(x) = 8x + \\frac{3}{x^2}$",
        "$f'(x) = 8x - \\frac{3}{x^2}$",
        "$f'(x) = 4x + \\frac{3}{x^2}$",
    ...
    {
      enonce: "Pour $h(x) = \\frac{3x + 3}{8x + 3}$, quelle est l'expression de $h'(x)$ ?",
      reponses: [
        "$h'(x) = \\frac{-15}{(8x + 3)^2}$",
        "$h'(x) = \\frac{15}{(8x + 3)^2}$",
        "$h'(x) = \\frac{-15}{8x + 3}$",
