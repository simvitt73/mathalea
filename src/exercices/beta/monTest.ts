...
export const dateDeModifImportante = '01/11/2025'
...
export const refs = {
  'fr-fr': ['3AutoN08'], // A changer obligatoirement, ne rien mettre si on ne veut pas que cet exercice soit référencé, donc trouvable dans le menu de gauche de MathALÉA
  'fr-ch': [],
}
...
$    Le this indique que ces paramétrages sont liés à l'objet Exercice.
  ...
  */
  ...
  nouvelleVersion() {
    ...
    */
    this.question = `Calculer le carré de ${a}`
    this.reponse = a * a
    this.correction = `Le carré d'un nombre est ce nombre multiplié par lui-même : $${a}\\times${a}=${this.reponse}$` // this.correction contient le texte visible en HTML et en PDF (LaTeX) dans la correction.
