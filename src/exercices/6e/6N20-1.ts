...
export default class EncadrerFractionEntre2Entiers extends Exercice {
  ...
  constructor () {
    super()
    this.consigne = `Compléter avec deux nombres entiers ${modalTexteCourt('Nombres entiers consécutifs : Ce sont deux nombres entiers qui se suivent comme 4 et 5.', 'consécutifs')}.`
