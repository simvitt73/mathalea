    ...
    this.affirmations = [
      {
        ...
        statut: true,
        correction: 'Le prix payé est proportionnel au nombre de litres achetés de ce jus car, par exemple, si le nombre de litres triple, le prix payé triple aussi.'
      },
      {
      ...
      },
      {
        ...
        statut: true,
        correction: 'Le nombre de calories est proportionnel au nombre de portions de ce gâteau car, par exemple, si le nombre de portions double, le nombre de calories double aussi.'
      },
      {
      ...
      },
      {
        ...
        statut: true,
        correction: 'Le temps de trajet est proportionnel à la distance car, par exemple, si la distance double, le temps de trajet double aussi.'
      },
      {
      ...
      },
      {
        ...
        statut: true,
        correction: 'La consommation de cet ordinateur est proportionnelle au nombre de jours car, par exemple, si le nombre de jours double, la consommation double aussi.'
      },
      {
        ...
        statut: true,
        correction: 'La quantité de CO₂ émise par cette voiture est proportionnelle à la distance parcourue car, par exemple, si la distance triple, la quantité de CO₂ triple aussi.'
      },
      {
      ...
      },
      {
        ...
        statut: true,
        correction: 'Le nombre d’espèces disparues est proportionnel au nombre d’années car, par exemple, si le nombre d’années double, le nombre d’espèces disparues double aussi.'
      },
      {
        ...
        statut: true,
        correction: 'La surface détruite est proportionnelle au nombre de jours car, par exemple, si le nombre de jours triple, la surface détruite triple aussi.'
      },
      {
        ...
        statut: true,
        correction: 'La hausse de température est proportionnelle au nombre de décennies car, par exemple, si le nombre de décennies double, la hausse de température double aussi.'
      },
      {
        ...
        statut: true,
        correction: 'La quantité jetée de plastique est proportionnelle au nombre d’années car, par exemple, si le nombre d’années triple, la quantité de plastique triple aussi.'
      },
      {
      ...
      },
      {
        ...
        statut: true,
        correction: 'Le total des points de cette équipe est proportionnel au nombre de matchs car, par exemple, si le nombre de matchs triple, le total des points triple aussi.'
      },
      {
      ...
      },
      {
        ...
        statut: false,
        correction: 'Le prix total n’est pas proportionnel au nombre de personnes car le tarif dépend de l’âge, donc il varie selon la composition du groupe.'
      },
      {
        ...
        statut: false,
        correction: 'Le prix total n’est pas proportionnel au nombre de livres car les réductions font varier le prix par livre.'
      },
      {
        texte: 'Si une voiture consomme, de façon irrégulière, plus en montée qu’en descente, alors la consommation est proportionnelle à la distance parcourue.',
        statut: false,
        correction: 'La consommation n’est pas proportionnelle à la distance car elle dépend aussi du relief.'
      },
      {
        ...
        statut: false,
        correction: 'La distance n’est pas proportionnelle au temps car les premières minutes ne servent pas à avancer.'
      },
      {
        ...
        statut: false,
        correction: 'Le prix n’est pas proportionnel au nombre de stations car un coût fixe est ajouté au départ.'
      },
      {
      ...
      },
      {
        ...
        statut: false,
        correction: 'La température n’est pas proportionnelle au temps car elle ne commence pas par zéro au départ.'
      },
      {
        ...
        statut: false,
        correction: 'La hauteur de cette plante n’est pas proportionnelle au nombre de semaines car la croissance n\'est pas la même chaque semaine.'
      },
      {
        ...
        statut: false,
        correction: 'Le prix de ce forfait n’est pas proportionnel au nombre de minutes car il y a un coût fixe qui fausse la proportion.'
      },
      {
      ...
      {
        texte: 'Si une lampe reste allumée plus ou moins longtemps selon l’usage, alors le temps d’éclairage est proportionnel au nombre d’allumages.',
        statut: false,
        correction: 'Le temps d’éclairage n’est pas proportionnel au nombre d’allumages car chaque durée est variable.'
      },
      {
      ...
      {
        texte: 'Si un téléphone se décharge plus vite pendant les jeux, alors la batterie utilisée est proportionnelle au temps d’utilisation.',
        statut: false,
        correction: 'La batterie utilisée n’est pas proportionnelle au temps car la consommation dépend de l’activité.'
      },
      {
        texte: 'Si un train change de vitesse pendant le trajet, alors la distance parcourue est proportionnelle au temps.',
        statut: false,
        correction: 'La distance n’est pas proportionnelle au temps car la vitesse n’est pas constante.'
      },
      {
        ...
        statut: false,
        correction: 'Le prix payé n’est pas proportionnel car la réduction ne s’applique qu’après un certain prix.'
      },
      {
        texte: 'Si le score d’un jeu dépend du temps et de la difficulté, alors le score est proportionnel au temps de jeu.',
        statut: false,
        correction: 'Le score n’est pas proportionnel au temps car il dépend aussi de la difficulté.'
      },
      {
        texte: 'Si un réservoir fuit irrégulièrement pendant qu’on le remplit, alors le volume d’eau est proportionnel au temps de remplissage.',
        statut: false,
        correction: 'Le volume d’eau n’est pas proportionnel au temps car une partie de l’eau est perdue de façon irrégulière.'
      },
      {
        texte: 'Si le prix d’un fruit change selon la saison, alors le prix est proportionnel au poids tout au long de l\'année.',
        statut: false,
        correction: 'Le prix, au long de l\'année, n’est pas proportionnel au poids car le prix au kilo n’est pas constant tout au long de l\'année.'
      },
      {
        texte: 'Si quelques élèves d\'une classe paient moins cher grâce à une réduction, alors le prix payé par l\'ensemble des élèves de cette classe est proportionnel au nombre de tickets.',
        statut: false,
        correction: 'Le prix payé par l\'ensemble des élèves n’est pas proportionnel au nombre de tickets car tous les tickets ne valent pas tous le même prix.'
      },
      {
