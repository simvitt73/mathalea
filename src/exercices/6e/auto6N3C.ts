...
export const titre = 'Passer, de façon automatique, d\'une valeur décimale à une valeur fractionnaire (et réciproquement) sur des valeurs simples'
...
export default class DecimaleAFractionnaire extends Exercice {
  constructor () {
    ...
    this.besoinFormulaireNumerique = ['Valeurs à trouver', 3, '1 : Fraction\n2 : Valeur décimale\n3 : Mélange']
    this.sup = 3
  }
      ...
      switch (typeQuestions[i]) {
        ...
        case 7 :
          ...
          texte = texteCorr + (this.interactif
            ? ('$' + remplisLesBlancs(this, i, '\\dfrac{%{champ1}}{2}', KeyboardType.clavierNumbers))
        ...
        case 8 :
          texteCorr = `$${texNombre(0.5)}=`
          texte = texteCorr + (this.interactif
            ? ('$' + remplisLesBlancs(this, i, '\\dfrac{1}{%{champ1}}', KeyboardType.clavierNumbers))
        ...
        case 9 :
          ...
          texte = texteCorr + (this.interactif
            ? ('$' + remplisLesBlancs(this, i, '\\dfrac{%{champ1}}{4}', KeyboardType.clavierNumbers))
        ...
        case 12 :
          texteCorr = `$${texNombre(0.75)}=`
          texte = texteCorr + (this.interactif
            ? ('$' + remplisLesBlancs(this, i, '\\dfrac{3}{%{champ1}}', KeyboardType.clavierNumbers))
            : texFractionFromString(1, '\\ldots') + '$')
          reponse = '4'
        ...
        case 16 :
          texteCorr = `$${texNombre(2)}=`
          texte = texteCorr + (this.interactif
            ? ('$' + remplisLesBlancs(this, i, '\\dfrac{4}{%{champ1}}', KeyboardType.clavierNumbers))
        ...
        case 18 :
          texteCorr = `$${texNombre(2.5)}=`
          texte = texteCorr + (this.interactif
            ? ('$' + remplisLesBlancs(this, i, '\\dfrac{5}{%{champ1}}', KeyboardType.clavierNumbers))
