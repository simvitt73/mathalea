    ...
    for (let i = 0, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      ...
      switch (typesDeQuestions) {
        case 1:{ // Cas f(x)=ax+b
          ...
          const lA = latexParCoordonnees('M\'', -x - 1.1, -a * x + b, 'red', 15, 10, 'white', 6)
          const lB = latexParCoordonnees('M', x - 1.1, a * x + b, 'red', 15, 10, 'white', 6)
        ...
        case 2:{ // Cas f(x)=ax
          ...
          const B = point(x, a * x)
          const A = point(-x, -a * x)
          const labA0 = latexParCoordonnees('-x', -x - 0.2, 0.8 * (a > 0 ? 1 : -1), 'red', 20, 10, 'white', 8)
          const labB0 = latexParCoordonnees('x', x, 0.8 * (a > 0 ? -1 : 1), 'red', 20, 10, 'white', 8)
          const lA = latexParCoordonnees('M\'', -x - 1, -a * x, 'red', 15, 10, 'white', 7)
          const lB = latexParCoordonnees('M', x + 1, a * x, 'red', 15, 10, 'white', 7)
          const labA1 = latexParCoordonnees('f(-x)=-f(x)', 3, 6, 'red', 90, 10, '', 10)
        ...
        case 3:{ // Cas f(x)=ax^2
          ...
          const labA0 = latexParCoordonnees('-x', -2 * x - 0.2, -0.8, 'red', 20, 10, 'white', 8)
          const labB0 = latexParCoordonnees('x', 2 * x, -0.8, 'red', 20, 10, 'white', 8)
          const lA = latexParCoordonnees('M\'', -2 * x - 1, a * x * x + b, 'red', 15, 10, 'white', 7)
          const lB = latexParCoordonnees('M', 2 * x + 1, a * x * x + b, 'red', 15, 10, 'white', 7)
          const labA1 = latexParCoordonnees('f(-x)=f(x)', 3.5, 4.5, 'red', 80, 10, '', 14)
          const traceAetB = tracePoint(A, B, 'red') // objet qui contient les croix des points
        ...
        case 4:{ // Cas f(x)=a(x-b)²+c
          ...
          const lA = latexParCoordonnees('M\'', -x - 1, a * (-x - b) * (-x - b) + c, 'red', 15, 10, 'white', 7)
          const lB = latexParCoordonnees('M', x + 1, a * (x - b) * (x - b) + c, 'red', 15, 10, 'white', 7)
        ...
        case 5:{ // Cas f(x)=1/ax+b
          ...
          const lA = texteParPosition('$M\'$', -x + (a > 0 ? -1 : 1), 1 / (-a * x + b) + (a > 0 ? 0.5 : -0.5), 0, 'red', 1.5)
          const lB = texteParPosition('$M$', x - (a > 0 ? -1 : 1), 1 / (a * x + b) + (a > 0 ? 0.5 : -0.5), 0, 'red', 1.5)
        ...
        default:{ // Cas f(x)=1/ax
          ...
          const labA0 = texteParPosition('$-x$', -2 * x - 0.2, -0.8, 0, 'red', 1)
          // labA0 = latexParCoordonnees('-x', -2*x - 0.2, -0.8, 'red', 20, 10, 'white', 8)
          const labB0 = texteParPosition('$x$', 2 * x - 0.2, -0.8, 0, 'red', 1)
          ...
          const labA1 = latexParCoordonnees('f(-x)=-f(x)', 3, 3, 'red', 80, 10, '', 14)
          const traceAetB = tracePoint(A, B, 'red') // objet qui contient les croix des points
