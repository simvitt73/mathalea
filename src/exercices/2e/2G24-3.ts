  ...
  nouvelleVersion () {
    ...
    for (let i = 0, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      ...
      switch (typesDeQuestions) {
        ...
        case 't3':
        default:{ // On donne 4 points à coordonnées entières
      ...
      if (this.questionJamaisPosee(i, wx.texFSD, wy.texFSD)) { // Si la question n'a jamais été posée, on en créé une autre
