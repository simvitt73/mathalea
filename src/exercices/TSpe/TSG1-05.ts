...
export default class NomExercice extends ExerciceSimple {
  ...
  nouvelleVersion () {
    ...
    this.question += 'On souhaite élire un binôme mixte de délégués de classe. <br>'
    this.question += 'Déterminer le nombre de binômes possibles. <br>'
    this.correction = 'Soit $F$ l\'ensemble des filles de la classe et $G$ l\'ensemble des garçons.<br>'
    this.correction += 'On cherche le nombre de couples $(f,g)\\in F \\times G$ .<br>'
    this.correction += 'En appliquanf le principe multiplicatif, on sait que $\\mathrm{card}(F \\times G) = \\mathrm{card}(F) \\times \\mathrm{card}(G)$.<br>'
