...
export const titre = 'Donner le nombre de solutions d\'une équation du second degré'
...
*/
export default class Can2025TQ20 extends Exercice {
  constructor () {
    super()
  ...
  nouvelleVersion () {
    ...
    const c = this.canOfficielle ? new FractionEtendue(b, 4) : choice([new FractionEtendue(b, 4), new FractionEtendue(b, 2)])
