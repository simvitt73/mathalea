...
Puis on isole $a$ : $${miseEnEvidence('a = \\dfrac{v^2}{R}')}$.`
      ...
      case 2 :
      default:
        this.question = 'On considère $x$, $y$ et $v$ des nombres réels positifs non nuls liés par la relation : <br>'
        this.question += choixQ
        ...
        this.distracteurs = choixQ
          ...
          : ['$v=\\dfrac{y-1}{x}$', '$v=\\sqrt{y} \\times x - 1$', '$v=\\dfrac{1}{x \\times \\sqrt{y}}$']
        if (choixQ) {
