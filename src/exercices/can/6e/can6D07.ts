...
export default class AutoFractionHeures extends ExerciceSimple {
  ...
  nouvelleVersion () {
    const durees = [['Un quart d\'heure', '\\dfrac14', '15', ' est égal'], ['Une demi-heure', '\\dfrac12', '30', 'est égale'], ['Trois quarts d\'heure', '\\dfrac34', '45', 'sont égaux']]
    ...
    this.canReponseACompleter = this.question + '$\\ldots\\ldots\\ldots\\ldots$ ' + 'minutes'
    this.correction = this.question + `$${miseEnEvidence(this.reponse)}$ minutes`
