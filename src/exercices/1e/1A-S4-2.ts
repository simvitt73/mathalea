...
export default class QuartileQCM extends ExerciceQcmA {
  ...
  private appliquerLesValeurs (valeurs: number[], effectif: number, quartile:number):
  void {
    ...
    if (rangQ1 - 2 >= 0) { distracteur1Q1 = serieClassee[rangQ1 - 2] } else { distracteur1Q1 = Q1 - 2 }
    ...
    if (rangQ1 - 2 >= 0) { distracteur1Q3 = serieClassee[rangQ3 - 2] } else { distracteur1Q3 = Q3 - 2 }
