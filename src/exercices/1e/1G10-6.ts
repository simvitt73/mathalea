  ...
  nouvelleVersion () {
    ...
    for (let i = 0, texte, texteCorr, reponse, objets, cpt = 0; i < this.nbQuestions && cpt < 50;) {
     ...
     ou encore   $\\vec{u}\\cdot\\vec{v}=\\dfrac{1}{2}\\left[\\Vert\\vec{u}\\Vert^2+\\Vert\\vec{v}\\Vert^2-\\Vert \\vec{u}-\\vec{v}\\Vert^2\\right]$.<br>
      ...
      const longueurBC = randint(5, Math.min(longueurAB + longueurAC - 2, 11), [longueurAB, longueurAC])
      const A = point(0, 0)
      ...
      const codeBC = angleOriente(A, B, C) > 0 ? texteSurSegment(`$${texNombre(longueurBC, 1)}$`, B, C, 'black', 0.5, true) : texteSurSegment(`$${texNombre(longueurBC, 1)}$`, C, B, 'black', 0.5, true)
      ...
      const intro = 'On écrit le produit scalaire de l\'énoncé avec des vecteurs de même origine : <br>'
...
&=\\dfrac{1}{2}\\left[${normeu}^2+${normev}^2-${normeuPMv}^2\\right]\\\\
             ...
             \\end{aligned}$`
              reponse = texNombre((normeu ** 2 + normev ** 2 - normeuPMv ** 2) / 2, 1)
              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: '<br>$\\vec{u}\\cdot\\vec{v}=$' }) + '<br>'
              break
            case 2 :
            default :
              texte = `Dans un repère orthonormé, on a $\\Vert\\vec{u}\\Vert=${normeu}$, $\\Vert\\vec{v}\\Vert=${normev}$ et $\\Vert\\vec{u}+\\vec{v}\\Vert=${normeuPMv}$.<br>
    ...
    &=\\dfrac{1}{2}\\left[${normeuPMv}^2-${normeu}^2-${normev}^2\\right]\\\\
                 ...
                 \\end{aligned}$`
              reponse = texNombre((normeuPMv ** 2 - normeu ** 2 - normev ** 2) / 2, 1)
              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: '<br>$\\vec{u}\\cdot\\vec{v}=$' }) + '<br>'
              break
          }
        ...
        case 2: //
          ...
          reponse = texNombre((longueurAB ** 2 + longueurAC ** 2 - longueurBC ** 2) / 2, 1)
          handleAnswers(this, i, { reponse: { value: reponse } })
          texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$\\overrightarrow{${nom[0]}${nom[1]}}\\cdot \\overrightarrow{${nom[0]}${nom[2]}}=$` }) + '<br>'
          break
        ...
        default:
          ...
          switch (randint(1, 2)) {
            case 1 :
              ...
              texte += figure
              texteCorr += intro + `$${choix ? `\\overrightarrow{${nom[1]}${nom[0]}}\\cdot \\overrightarrow{${nom[0]}${nom[2]}}` : `\\overrightarrow{${nom[0]}${nom[1]}}\\cdot \\overrightarrow{${nom[2]}${nom[0]}}`}=-\\overrightarrow{${nom[0]}${nom[1]}}\\cdot \\overrightarrow{${nom[0]}${nom[2]}}$.<br>
              ...
              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$${choix ? `\\overrightarrow{${nom[1]}${nom[0]}}\\cdot \\overrightarrow{${nom[0]}${nom[2]}}` : `\\overrightarrow{${nom[0]}${nom[1]}}\\cdot \\overrightarrow{${nom[2]}${nom[0]}}`}=$` })
              break
            case 2 :
            default:
              reponse = texNombre((longueurAB ** 2 + longueurAC ** 2 - longueurBC ** 2) / 2, 1)
              ...
              texte += figure
              texteCorr += intro + `$\\overrightarrow{${nom[1]}${nom[0]}}\\cdot \\overrightarrow{${nom[2]}${nom[0]}}=(-\\overrightarrow{${nom[0]}${nom[1]}})\\cdot (-\\overrightarrow{${nom[0]}${nom[2]}})=\\overrightarrow{${nom[0]}${nom[1]}}\\cdot \\overrightarrow{${nom[0]}${nom[2]}}$<br>
                ` + corrMemeOrigine

              handleAnswers(this, i, { reponse: { value: reponse } })
              texte += ajouteChampTexteMathLive(this, i, KeyboardType.clavierDeBase, { texteAvant: `<br>$\\overrightarrow{${nom[1]}${nom[0]}}\\cdot \\overrightarrow{${nom[2]}${nom[0]}}=$` })
              break
          }
          break
      }
