...
export default class ModeliserSuites extends Exercice {
  ...
  nouvelleVersion () {
    for (let i = 0, cpt = 0; i < this.nbQuestions && cpt < 50;) {
      let texte = ''
      let texteCorr = ''
      let val1, val2, val3, listeEV, ev, Pev1, Pev1b, Pev2sachantev1, Pev2sachantev1b, Pev2, Pev1sachantev2, Pev1bsachantev2, liste, intro, texte1, calc1, calc2, calc3, calc4, calc5, calc6, calc1C, calc2C, calc3C, calc4C, calc5C, calc6C
...
Enfin, ils estiment que $${texNombre(Pev2 * 100, 1)}\\,\\%$ des animaux contractent la maladie.<br>`
          ...
          intro = 'Face à la menace d’une épidémie frappant les troupeaux de bovins, les services sanitaires décident d’organiser une vaccination de masse.<br>'
      ...
      if (this.sup === 1) {
        ...
        calc2 = this.interactif ? ajouteChampTexteMathLive(this, 3 * i + 1, KeyboardType.clavierDeBase, { texteAvant: `$P(${ev[1]})=$` }) : `$P(${ev[1]})=\\ldots$`
        calc3 = this.interactif ? ajouteChampTexteMathLive(this, 3 * i + 2, KeyboardType.clavierDeBase, { texteAvant: `$P_{\\overline{${ev[0]}}}({${ev[1]}})=$` }) : `$P_{\\overline{${ev[0]}}}({${ev[1]}})=\\ldots$`
        ...
        calc4 = this.interactif ? ajouteChampTexteMathLive(this, 3 * i, KeyboardType.clavierProbabilite, { texteAvant: `$P_{${ev[1]}}( \\overline{${ev[0]}})=$` }) : `$P_{${ev[1]}}( \\overline{${ev[0]}})=\\ldots$`
        calc5 = this.interactif ? ajouteChampTexteMathLive(this, 3 * i + 1, KeyboardType.clavierProbabilite, { texteAvant: `$P({${ev[0]}}\\cap {${ev[1]}})=$` }) : `$P({${ev[0]}}\\cap {${ev[1]}})=\\ldots$`
        calc6 = this.interactif ? ajouteChampTexteMathLive(this, 3 * i + 2, KeyboardType.clavierProbabilite, { texteAvant: `$P( ${ev[0]})=$` }) : `$P( ${ev[0]})=\\ldots$`
        ...
        if (choice([true, false])) {
          texte += ` ${calc1}${sp(10)}${calc2}${sp(10)}${calc3}`
          handleAnswers(this, 3 * i, { reponse: { value: texNombre(Pev2sachantev1, 3), options: { texteAvecCasse: true } } })
          handleAnswers(this, 3 * i + 1, { reponse: { value: texNombre(Pev2, 3), options: { texteAvecCasse: true } } })
          handleAnswers(this, 3 * i + 2, { reponse: { value: texNombre(Pev2sachantev1b, 3), options: { texteAvecCasse: true } } })
          texteCorr = ` ${calc1C}${sp(10)}${calc2C}${sp(10)}${calc3C}`
        } else {
          texte += ` ${calc4}${sp(10)}${calc5}${sp(10)}${calc6}`
          handleAnswers(this, 3 * i, { reponse: { value: texNombre(Pev1bsachantev2, 3), options: { texteAvecCasse: true } } })
          handleAnswers(this, 3 * i + 1, { reponse: { value: texNombre(Pev1 * Pev2sachantev1, 3), options: { texteAvecCasse: true } } })
          handleAnswers(this, 3 * i + 2, { reponse: { value: texNombre(Pev1, 3), options: { texteAvecCasse: true } } })
          texteCorr = `${calc4C}${sp(10)}${calc5C}${sp(10)}${calc6C}`
        }
      }
