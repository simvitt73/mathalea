...
export default class AutoC4c extends ExerciceQcmA {
  ...
  versionAleatoire: () => void = () => { 
      ...
      case 1:
        ...
        this.reponses = ['$\\dfrac{1}{6}$', '$\\dfrac{1}{5}$', '$\\dfrac{2}{3}$', '$\\dfrac{3}{2}$']
        break
      ...
      case 3:
        ...
        this.reponses = ['$\\dfrac{1}{8}$', '$\\dfrac{1}{6}$', '$\\dfrac{2}{4}$', '$\\dfrac{4}{2}$']
        break
      ...
      case 4:
        ...
        this.reponses = ['$\\dfrac{1}{15}$', '$\\dfrac{1}{8}$', '$\\dfrac{5}{3}$', '$\\dfrac{3}{5}$']
        break
      ...
      case 5:
        ...
        this.reponses = ['$\\dfrac{1}{20}$', '$\\dfrac{1}{9}$', '$\\dfrac{5}{4}$', '$\\dfrac{4}{5}$']
        break
      ...
      case 6:
        ...
        this.reponses = ['$\\dfrac{1}{10}$', '$\\dfrac{1}{7}$', '$\\dfrac{2}{5}$', '$\\dfrac{5}{2}$']
        break
      ...
      case 7:
        ...
        this.reponses = ['$\\dfrac{1}{12}$', '$\\dfrac{1}{7}$', '$\\dfrac{4}{3}$', '$\\dfrac{3}{4}$']
        break
      ...
      case 8:
        ...
        this.reponses = ['$\\dfrac{1}{12}$', '$\\dfrac{1}{8}$', '$\\dfrac{6}{2}$', '$\\dfrac{2}{6}$']
        break
      ...
      case 9:
        ...
        this.reponses = ['$\\dfrac{1}{18}$', '$\\dfrac{1}{9}$', '$\\dfrac{3}{6}$', '$\\dfrac{6}{3}$']
        break
      ...
      case 10:
        ...
        this.reponses = ['$\\dfrac{1}{20}$', '$\\dfrac{1}{9}$', '$\\dfrac{4}{5}$', '$\\dfrac{5}{4}$']
        break
      ...
      case 11:
        ...
        this.reponses = ['$\\dfrac{1}{16}$', '$\\dfrac{1}{10}$', '$\\dfrac{8}{2}$', '$\\dfrac{2}{8}$']
        break
      ...
      case 12:
        ...
        this.reponses = ['$\\dfrac{1}{30}$', '$\\dfrac{1}{13}$', '$\\dfrac{10}{3}$', '$\\dfrac{3}{10}$']
        break
      ...
      case 13:
        ...
        this.reponses = ['$\\dfrac{1}{28}$', '$\\dfrac{1}{11}$', '$\\dfrac{7}{4}$', '$\\dfrac{4}{7}$']
        break
      ...
      case 14:
        ...
        this.reponses = ['$\\dfrac{1}{18}$', '$\\dfrac{1}{11}$', '$\\dfrac{9}{2}$', '$\\dfrac{2}{9}$']
        break
      ...
      case 15:
        ...
        this.reponses = ['$\\dfrac{1}{30}$', '$\\dfrac{1}{11}$', '$\\dfrac{5}{6}$', '$\\dfrac{6}{5}$']
        break
      ...
      case 16:
        ...
        this.reponses = ['$\\dfrac{1}{6}$', '$\\dfrac{2}{7}$', '$\\dfrac{6}{4}$', '$\\dfrac{8}{3}$']
        break
      ...
      case 17:
        ...
        this.reponses = ['$\\dfrac{3}{8}$', '$\\dfrac{3}{6}$', '$\\dfrac{7}{4}$', '$\\dfrac{4}{6}$']
        break
      ...
      case 18:
        ...
        this.reponses = ['$\\dfrac{2}{15}$', '$\\dfrac{2}{8}$', '$\\dfrac{7}{5}$', '$\\dfrac{5}{8}$']
        break
      ...
      case 19:
        ...
        this.reponses = ['$\\dfrac{1}{10}$', '$\\dfrac{2}{9}$', '$\\dfrac{6}{5}$', '$\\dfrac{7}{4}$']
        break
      ...
      case 20:
        ...
        this.reponses = ['$\\dfrac{3}{10}$', '$\\dfrac{3}{7}$', '$\\dfrac{8}{5}$', '$\\dfrac{5}{7}$']
        break
      ...
      case 21:
        ...
        this.reponses = ['$\\dfrac{4}{15}$', '$\\dfrac{4}{8}$', '$\\dfrac{9}{5}$', '$\\dfrac{7}{3}$']
        break
      ...
      case 22:
        ...
        this.reponses = ['$\\dfrac{3}{20}$', '$\\dfrac{3}{9}$', '$\\dfrac{7}{4}$', '$\\dfrac{8}{5}$']
        break
      ...
      case 23:
        ...
        this.reponses = ['$\\dfrac{5}{24}$', '$\\dfrac{5}{10}$', '$\\dfrac{11}{6}$', '$\\dfrac{9}{4}$']
        break
      ...
      case 24:
        ...
        this.reponses = ['$\\dfrac{2}{15}$', '$\\dfrac{2}{8}$', '$\\dfrac{7}{3}$', '$\\dfrac{8}{5}$']
        break
      ...
      case 25:
        ...
        this.reponses = ['$\\dfrac{3}{14}$', '$\\dfrac{3}{9}$', '$\\dfrac{10}{7}$', '$\\dfrac{5}{2}$']
        break
    }
  }
