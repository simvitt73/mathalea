      ...
      if (listeTypeDeQuestions[i] < 3) {
        ...
        while (b < 50 && (
          F1.num === F2.num ||
            ...
            this.sup2 &&
            (
              nombreDeChiffresDansLaPartieDecimale(arrondi(Math.max(F1.den, F2.den) / Math.min(F1.den, F2.den))) !== 0 ||
Math.max(F1.den, F2.den) / Math.min(F1.den, F2.den) > 11
        ...
        pb3f.push({
          ...
          enonce: '',
          question: (this.interactif ? numAlpha(0) : '') + 'Pour quelle discipline, la distance parcourue est-elle la plus grande ?',
          correction: '',
          question2: 'Classer, par ordre croissant, les fractions respectives associées à chaque discipline.'
        })
        ...
        pb3f.push({
          ...
          correction: '',
          question2: 'Classer, par ordre croissant, les proportions des suffrages associées à chaque candidate.'
        })
        ...
        //= =====================================================
        pb3f[1].correction += 'Calculons d\'abord la proportion des suffrages remportés par '
        ...
        pb3f[0].correction += `<br> 
                      C'est donc en ${texteEnCouleurEtGras(`${pb3f[0].fractions[pb3f[0].fractions.indexOf(fracRangees[2]) + 1
        ...
        pb3f[1].correction += `<br> 
                      C'est donc ${texteEnCouleurEtGras(`${pb3f[1].fractions[pb3f[1].fractions.indexOf(fracRangees[2]) + 1
                      ]}`)} qui a été élue.`
      } else {
        //= =====================================================
        //= ======= AVEC 4 FRACTIONS=======
        ...
        while (b < 100 && (
          F1.num === F2.num ||
            ...
            (
              nombreDeChiffresDansLaPartieDecimale(arrondi(Math.max(F1.den, F2.den) / Math.min(F1.den, F2.den))) !== 0 ||
              nombreDeChiffresDansLaPartieDecimale(arrondi(Math.max(F1.den, F3.den) / Math.min(F1.den, F3.den))) !== 0 ||
              nombreDeChiffresDansLaPartieDecimale(arrondi(Math.max(F3.den, F2.den) / Math.min(F3.den, F2.den))) !== 0 ||
Math.max(F1.den, F2.den) / Math.min(F1.den, F2.den) > 13 ||
Math.max(F1.den, F3.den) / Math.min(F1.den, F3.den) > 13 ||
Math.max(F3.den, F2.den) / Math.min(F3.den, F2.den) > 13
            )
          ) || ( // Niveau propre à la 4ème
            !this.sup2 &&
            (
              F1.den === F3.den || F2.den === F3.den
            )
          )
        )
        ) {
        ...
        pb4f.push({
          ...
          correction: '',
          question2: 'Classer, par ordre croissant, les fractions associées à chaque couleur.'
        ...
        pb4f.push({
          ...
          correction: '',
          question2: 'Classer, par ordre croissant, les fractions associées à chaque culture.'
        })
        ...
        pb4f.push({
          ...
          correction: '',
          question2: 'Classer, par ordre croissant, les fractions associées à chaque catégorie dans le stade.'
        })
        ...
        //= =====================================================
        pb4f[0].correction += 'Calculons d\'abord la fraction du mandala recouverte en '
        ...
        pb4f[0].correction += `<br> 
                      C'est donc en ${texteEnCouleurEtGras(`${pb4f[0].fractions[pb4f[0].fractions.indexOf(fracRangees[3]) + 1
        ...
        pb4f[1].correction += `<br> 
                      C'est donc par ${texteEnCouleurEtGras(`${pb4f[1].fractions[pb4f[1].fractions.indexOf(fracRangees[3]) + 1
        ...
        pb4f[2].correction += `<br> 
                      C'est donc pour ${texteEnCouleurEtGras(`${pb4f[2].fractions[pb4f[2].fractions.indexOf(fracRangees[3]) + 1
      ...
      const probleme = listeTypeDeQuestions[i] < 3 ? pb3f[listeTypeDeQuestions[i] - 1] : pb4f[listeTypeDeQuestions[i] - 3]
      ...
      if (this.interactif) {
        ...
        const propositionsFinales = [
          {
            ...
            statut: `${probleme.fractions[probleme.fractions.indexOf(fracRangees[indiceFracRangees]) + 1]}` === probleme.fractions[1]
          },
          {
            texte: probleme.fractions[3],
            statut: `${probleme.fractions[probleme.fractions.indexOf(fracRangees[indiceFracRangees]) + 1]}` === probleme.fractions[3]
          },
          {
            texte: probleme.fractions[5],
            statut: `${probleme.fractions[probleme.fractions.indexOf(fracRangees[indiceFracRangees]) + 1]}` === probleme.fractions[5]
          }
        ]
        if (listeTypeDeQuestions[i] > 2) {
          propositionsFinales.push({
            texte: probleme.fractions[7],
            statut: `${probleme.fractions[probleme.fractions.indexOf(fracRangees[indiceFracRangees]) + 1]}` === probleme.fractions[7]
          })
        }
        ...
        texte += '<br>' + remplisLesBlancs(this,
          2 * i + 1,
          '%{champ1}~<~%{champ2}~<~%{champ3}' + (listeTypeDeQuestions[i] > 2 ? '~<~%{champ4}' : ''),
        ...
        handleAnswers(
          ...
          listeTypeDeQuestions[i] < 3
            ...
            : {
                bareme: (listePoints) => [3 * (listePoints[0] * listePoints[1] * listePoints[2] * listePoints[3]), 3],
                champ1: { value: fracMemeDenomRangees[0].texFraction },
                champ2: { value: fracMemeDenomRangees[1].texFraction },
                champ3: { value: fracMemeDenomRangees[2].texFraction },
