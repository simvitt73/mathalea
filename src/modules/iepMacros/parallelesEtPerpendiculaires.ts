...
type OptionsCompasAvecDescription = OptionsCompas & {
  description?: boolean
}
...
export const paralleleRegleEquerre2points3epoint = function (this: Alea2iep, A: PointAbstrait, B: PointAbstrait, C: PointAbstrait, options?: OptionsEquerre) {
  ...
  if (H1.y > C1.y) {
    if (this.regle.visibilite) {
      ...
      this.regleDeplacer(H1, Object.assign({}, options, { vitesse: 1000, tempo: 0 }))
      this.regleRotation(C1, Object.assign({}, options, { sens: 1000, tempo: 0 }))
    }
  } else {
    ...
    if (this.regle.visibilite) {
      ...
      this.regleDeplacer(C12, Object.assign({}, options, { vitesse: 1000, tempo: 0 }))
      this.regleRotation(H1, Object.assign({}, options, { sens: 1000, tempo: 0 }))
      this.regleMontrer()
    }
  }
...
/**
   ...
   * @param {*} [options]
   */
export const perpendiculaireRegleEquerre2points3epoint = function (this: Alea2iep, A: PointAbstrait, B: PointAbstrait, C: PointAbstrait, options: OptionsCompasAvecDescription = {}) {
 ...
 */
export const perpendiculaireRegleEquerreDroitePoint = function (this: Alea2iep, d: Droite, P: PointAbstrait, options: OptionsCompasAvecDescription = {}) {
  if (!P.estSur(d)) {
    ...
    if (options.description) this.textePosition(`1. Placer un côté de l'angle droit de l'équerre sur la droite ${d.nom} et l'autre côté de l'angle droit passant par le point ${P.nom}.`, 0, 10, { couleur: 'lightblue' })
    this.equerreRotation(alpha, options)
    this.equerreMontrer(H, options)
    if (options.description) this.textePosition(`2. Tracer le segment de droite passant par le point ${P.nom}`, 0, 9.3, { couleur: 'lightblue' })
    this.crayonMontrer(P, options)
    this.tracer(H, options)
    this.equerreMasquer(options)
    if (options.description) this.textePosition(`3. Prolonger la perpendiculaire à ${d.nom} à la règle.`, 0, 8.6, { couleur: 'lightblue' })
    ...
    if (options.description) this.textePosition('4. Coder l\'angle droit.', 0, 7.9, { couleur: 'lightblue' })
    this.regleMasquer(options)
    this.codageAngleDroit(A, H, P, Object.assign({}, options, { couleurCodage: 'red' }))
  } else {
    const H = P
    const C = cercle(P, 6)
    ...
    const alpha = angleOriente(point(10000, H.y), H, B)
    if (options.description) this.textePosition(`1. Placer un côté de l'angle droit de l'équerre sur la droite ${d.nom} avec l'angle droit au point ${P.nom}.`, 0, 10, { couleur: 'lightblue' })
    this.equerreRotation(alpha, options)
    this.equerreMontrer(H, options)
    if (options.description) this.textePosition('2. Tracer le long de l\'autre côté de l\'angle droit de l\'équerre', 0, 9.3, { couleur: 'lightblue' })
 ...
 * @param {boolean} description
 */
export const perpendiculaireRegleEquerrePointSurLaDroite = function (this: Alea2iep, d: Droite, x: number, options: OptionsCompasAvecDescription = {}) {
  ...
  if (options.description) this.textePosition(`1. Placer un côté de l'angle droit de l'équerre sur la droite ${d.nom}.`, 0, 10, { couleur: 'lightblue' })
  ...
  if (options.description) this.textePosition('3. Tracer le long de l\'autre côté de l\'angle droit de l\'équerre.', 0, 8.6, { couleur: 'lightblue' })
  this.crayonMontrer(A, options)
  this.tracer(P1, options)
  this.equerreMasquer(options)
  if (options.description) this.textePosition(`4. Prolonger la perpendiculaire à ${d.nom} à la règle.`, 0, 7.9, { couleur: 'lightblue' })
  ...
  if (options.description) this.textePosition('4. Coder l\'angle droit.', 0, 7.2, { couleur: 'lightblue' })
  this.regleMasquer(options)
 ...
 * @param {boolean} description
 */
export const perpendiculaireCompasPointSurLaDroite = function (this: Alea2iep, d: Droite, x: number, options: OptionsCompasAvecDescription = {}) {
  const A = pointSurDroite(d, x, 'A')
  ...
  this.traitRapide(pointSurDroite(d, -20), pointSurDroite(d, 20), options)
  this.pointCreer(A, options)
  if (options.description) this.textePosition('1. Avec le compas, marquer deux points B et C de part et d\'autre de A, tels que AB=AC.', 0, 10, { couleur: 'lightblue' })
  ...
  if (options.description) this.textePosition('3. Tracer un arc de cercle de centre B avec cet écartement.', 0, 8.6, { couleur: 'lightblue' })
  this.compasTracerArcCentrePoint(B, P1, { couleur: 'lightgray', epaisseur: 1 })
  if (options.description) this.textePosition('4. Tracer un arc de cercle de centre C en conservant le même écartement.', 0, 7.9, { couleur: 'lightblue' })
  ...
  if (options.description) this.textePosition('5. Coder l\'angle droit.', 0, 6.5, { couleur: 'lightblue' })
  this.regleMasquer(options)
  this.codageAngleDroit(P1, A, B, options)
}
/**
 ...
 * @param {boolean} description
 */
export const perpendiculaireCompasPoint = function (this: Alea2iep, d: Droite, A: PointAbstrait, options: OptionsCompasAvecDescription = {}) {
  ...
  this.traitRapide(pointSurDroite(d, -20), pointSurDroite(d, 20), options)
  this.textePoint(d.nom, translation(pointSurDroite(d, 0), vecteur(0, -0.5)), options)
  this.pointCreer(A, options)
  if (options.description) this.textePosition(`1. Choisir deux points B et C sur la droite ${d.nom}.`, 0, 11, { couleur: 'lightblue', tempo: 20 })
  this.tempo = 20
  this.pointCreer(B, options)
  this.pointCreer(C, options)
  if (options.description) this.textePosition(`2. Tracer un arc de cercle de centre B passant par A et un autre de centre C passant par ${A.nom}.`, 0, 10.3, { couleur: 'lightblue', tempo: 20 })
  this.compasEcarter2Points(B, A, options)
  this.compasTracerArcCentrePoint(B, D, Object.assign({}, options, { couleur: 'lightgray', epaisseur: 1 }))
  this.compasEcarter2Points(C, A, options)
  this.compasTracerArcCentrePoint(C, D, Object.assign({}, options, { couleur: 'lightgray', epaisseur: 1 }))
  if (options.description) this.textePosition(`3. Ces deux arcs de cercle se recoupent en un point qui est le symétrique de ${A.nom} par rapport à ${d.nom}`, 0, 9.6, { couleur: 'lightblue', tempo: 20 })
  this.compasMasquer(options)
  if (options.description) this.textePosition('4. Tracer la droite qui passe par le point d\'intersection des arcs de cercle et par le point A.', 0, 8.9, { couleur: 'lightblue', tempo: 20 })
  this.regleRotation(d.angleAvecHorizontale - 90, options)
  this.regleMontrer(P1, options)
  this.crayonMontrer(P1, options)
  this.tracer(P2, options)
  if (options.description) this.textePosition('5. Coder l\'angle droit.', 0, 8.2, { couleur: 'lightblue', tempo: 20 })
  this.regleMasquer(options)
...
/**
   ...
   * @param {*} [options]
   */
export const paralleleRegleEquerreDroitePointAvecDescription = function (this: Alea2iep, A: PointAbstrait, B: PointAbstrait, M: PointAbstrait, dessus: boolean, options: OptionsCompasAvecDescription = { description: true }) {
  A.nom = 'A'
  B.nom = 'B'
  M.nom = 'M'
  ...
  if (options.description) this.textePosition('On veut construire la parallèle à (AB) passant par M à la règle et à l\'equerre.', -10, 10, { couleur: 'red', taille: 4, tempo: 50 })
  if (options.description) this.textePosition('1. Placer l\'équerre un côté de l\'angle droit le long de la droite (AB).', -9, 9.3, { couleur: 'lightblue', taille: 2, tempo: 10 })
  this.equerreMontrer(A, options)
  this.equerreRotation(d.angleAvecHorizontale + (dessus ? -90 : 0), Object.assign({}, options, { tempo: 20 }))
  if (options.description) this.textePosition('2. Placer ensuite la règle contre l\'autre côté de l\'angle droit de l\'équerre.', -9, 8.6, { couleur: 'lightblue', taille: 2, tempo: 10 })
  this.regleRotation(d.angleAvecHorizontale - 90, options)
  this.regleMontrer(AA, options)
  this.regleDeplacer(homothetie(rotation(B, A, 90), A, 1.5), Object.assign({}, options, { tempo: 20 }))
  if (options.description) this.textePosition('Remarque : On peut tracer des pointillés pour matérialiser la position de la règle.', -9.5, 7.9, { couleur: 'pink', taille: 2, tempo: 10 })
  this.crayonMontrer(A, options)
  this.tracer(homothetie(rotation(B, A, dessus ? 90 : -90), A, 1.5), options)
  if (options.description) this.textePosition('3. Faire glisser l\'équerre le long de la règle jusqu\'au point M.', -9, 7.2, { couleur: 'lightblue', taille: 2, tempo: 10 })
  if (!dessus) {
    this.equerreRotation(d.angleAvecHorizontale - 90, options)
  }
  this.equerreDeplacer(H, Object.assign({}, options, { tempo: 20 }))
  if (options.description) this.textePosition('4. Tracer le segment de droite passant par M.', -9, 6.5, { couleur: 'lightblue', taille: 2, tempo: 10 })
  this.crayonDeplacer(H, options)
  this.tracer(N, options)
  this.equerreMasquer(options)
  if (options.description) this.textePosition('5. Placer la règle sur ce segment et prolonger la parallèle à (AB).', -9, 5.8, { couleur: 'lightblue', taille: 2, tempo: 10 })
  this.regleDeplacer(P, options)
  this.regleRotation(d.angleAvecHorizontale, options)
  this.tracer(P, options)
  this.regleMasquer(options)
  if (options.description) this.textePosition('6. Pour finir, coder la figure.', -9, 5.1, { couleur: 'lightblue', taille: 2, tempo: 20 })
 ...
 * @param {boolean} description
 */
export const paralleleAuCompasAvecDescription = function (this: Alea2iep, A: PointAbstrait, B: PointAbstrait, C: PointAbstrait, options: OptionsCompasAvecDescription = { description: true }) {
  ...
  if (options.description) this.textePosition('On veut construire la parallèle à (AB) passant par C à la règle et au compas.', -10, 10, { couleur: 'red', taille: 4, tempo: 30 })
  if (options.description) this.textePosition('1. Prendre avec le compas l\'écartement correspondant à la longueur AB.', -9, 9.3, { couleur: 'lightblue', taille: 2, tempo: 10 })
  this.compasEcarter2Points(A, B, options)
  if (options.description) this.textePosition('2. Reporter cette longueur à partir du point C.', -9, 8.6, { couleur: 'lightblue', taille: 2, tempo: 10 })
  this.compasTracerArcCentrePoint(C, D, Object.assign({}, options, { couleur: 'lightgray', epaisseur: 1 }))
  if (options.description) this.textePosition('3. Prendre ensuite avec le compas l\'écartement correspondant à la longueur AC.', -9, 7.9, { couleur: 'lightblue', taille: 2, tempo: 10 })
  this.compasEcarter2Points(A, C, options)
  if (options.description) this.textePosition('4. Reporter cette longueur à partir du point B.', -9, 7.2, { couleur: 'lightblue', taille: 2, tempo: 10 })
  this.compasTracerArcCentrePoint(B, D, Object.assign({}, options, { couleur: 'lightgray', epaisseur: 1 }))
  this.compasMasquer(options)
  if (options.description) this.textePosition('5. Noter D, le point d\'intersection des deux arcs de cercle.', -9, 6.5, { couleur: 'lightblue', taille: 2, tempo: 10 })
  this.pointCreer(D, options)
  if (options.description) this.textePosition('6. Tracer la droite passant par C et D.', -9, 5.8, { couleur: 'lightblue', taille: 2, tempo: 10 })
 ...
 * @param {boolean} description
 */
export const paralleleAuCompas = function (this: Alea2iep, A: PointAbstrait, B: PointAbstrait, C: PointAbstrait, options: OptionsCompas = {}) {
