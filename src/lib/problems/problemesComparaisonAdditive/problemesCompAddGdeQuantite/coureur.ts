...
export function coureur5 (decimal = true): Probleme {
  ...
  const enonce = `${personnage.prenom} a réalisé un trail au cours duquel ${personnage.pronom} a couru sur $${texNombre(nb1, 3)}$ ${uniteComplete} et a marché $${texNombre(nb2, 3)}$ ${uniteComplete} de plus que ce qu'${personnage.pronom} a couru.
