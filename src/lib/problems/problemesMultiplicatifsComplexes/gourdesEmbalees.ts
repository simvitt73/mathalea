...
export function gourdes (decimal = false): Probleme {
  ...
  if (!egal(data.nb1Fois * data.part1, nb2Fois * data.part2)) probleme.correction += `Comme on ne peut pas acheter une fraction de rouleau, il faut acheter : $${Math.ceil(data.nb1Fois * data.part1 / data.part2)}$ rouleaux de carton.`
