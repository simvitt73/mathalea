...
<div style="break-inside:avoid" id="consigne{exerciseIndex}-{questionIndex}" class="container max-w-full text-justify grid grid-cols-1 auto-cols-min gap-4 mb-2 lg:mb-4">
  ...
  {#if isCorrectionVisible}
    ...
    >
      ...
      <div class="container max-w-full text-justify overflow-x-auto overflow-y-hidden md:overflow-x-auto py-1" style="line-height: {exercise.spacingCorr || 1}; break-inside:avoid">
        <!-- eslint-disable-next-line svelte/no-at-html-tags -->
