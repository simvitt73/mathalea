...
const numerationCaps: CompleteKeysList = {
  inline: ['MILLIARD', 'MILLION', 'MILLE', 'CENTAINE', 'DIZAINE', 'UNITE', 'DE', 'DIXIEME', 'CENTIEME', 'MILLIEME', 'DIX_MILLIEME', 'CENT_MILLIEME', 'MILLIONIEME', 'HYPHEN', 'DIX', 'VINGT', 'TRENTE', 'QUARANTE', 'CINQUANTE', 'SOIXANTE', 'SOIXANTE_DIX', 'QUATRE_VINGT', 'QUATRE_VINGT_DIX', 'CENT'],
  block: ['MILLIARD', 'MILLION', 'MILLE', 'CENTAINE', 'DIZAINE', 'UNITE', 'DE', 'DIXIEME', 'CENTIEME', 'MILLIEME', 'DIX_MILLIEME', 'CENT_MILLIEME', 'MILLIONIEME', 'HYPHEN', 'DIX', 'VINGT', 'TRENTE', 'QUARANTE', 'CINQUANTE', 'SOIXANTE', 'SOIXANTE_DIX', 'QUATRE_VINGT', 'QUATRE_VINGT_DIX', 'CENT']
}
