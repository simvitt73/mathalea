...
if (void 0 === window.Persistence) { const e = 'github.com/SimonLammer/anki-persistence/'; const t = '_default'; if (window.Persistence_sessionStorage = function () { let i = !1; try { typeof window.sessionStorage === 'object' && (i = !0, this.clear = function () { for (let t = 0; t < sessionStorage.length; t++) { const i = sessionStorage.key(t); i.indexOf(e) == 0 && (sessionStorage.removeItem(i), t--) } }, this.setItem = function (i, n) { void 0 == n && (n = i, i = t), sessionStorage.setItem(e + i, JSON.stringify(n)) }, this.getItem = function (i) { return void 0 == i && (i = t), JSON.parse(sessionStorage.getItem(e + i)) }, this.removeItem = function (i) { void 0 == i && (i = t), sessionStorage.removeItem(e + i) }, this.getAllKeys = function () { for (var t = [], i = Object.keys(sessionStorage), n = 0; n < i.length; n++) { const s = i[n]; s.indexOf(e) == 0 && t.push(s.substring(e.length, s.length)) } return t.sort() }) } catch (n) { } this.isAvailable = function () { return i } }, window.Persistence_windowKey = function (i) { const n = window[i]; let s = !1; typeof n === 'object' && (s = !0, this.clear = function () { n[e] = {} }, this.setItem = function (i, s) { void 0 == s && (s = i, i = t), n[e][i] = s }, this.getItem = function (i) { return void 0 == i && (i = t), void 0 == n[e][i] ? null : n[e][i] }, this.removeItem = function (i) { void 0 == i && (i = t), delete n[e][i] }, this.getAllKeys = function () { return Object.keys(n[e]) }, void 0 == n[e] && this.clear()), this.isAvailable = function () { return s } }, window.Persistence = new Persistence_sessionStorage(), Persistence.isAvailable() || (window.Persistence = new Persistence_windowKey('py')), !Persistence.isAvailable()) { const i = window.location.toString().indexOf('title'); const n = window.location.toString().indexOf('main', i); i > 0 && n > 0 && n - i < 10 && (window.Persistence = new Persistence_windowKey('qt')) } }
